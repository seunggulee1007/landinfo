               ...
               <!-- 입력 폼 -->
                <form class="">
                                ...
                                <div class="col-md-6 col-lg-3 mb-1">
                                 ...
                                 <div class="col-md-6 col-lg-3 mb-1">
                                     <select class="form-control" id="kinds" name="kinds">
                                        ...
                                        <option value="1">빌딩/건물</option>
                                        <option value="2">상가건물</option>
                                        <option value="3">숙박/콘도</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4 col-md-3 col-lg-2 mb-1">
                            <input type="text" class="form-control" id="area_size" placeholder="토지면적(평방미터)" name="area_size">
                        </div>
                        <div class="col-sm-4 col-md-3 col-lg-2 mb-1">
                            <input type="text" class="form-control" id="building_size" placeholder="건물면적(평방미터)" name="building_size">
                        </div>
                        <div class="col-sm-4 col-md-3 col-lg-2 mb-1">
                        ...
                        <div class="col-sm-4 col-md-3 col-lg-2 mb-1">
                            <input type="text" class="form-control" id="move_in_dt" placeholder="입주가능일" name="move_in_dt">
                        </div>
                        <div class="col-sm-4 col-md-3 col-lg-2 mb-1">
                        ...
                        <div class="col-sm-4 col-md-3 col-lg-2 mb-1">
                            <input type="text" class="form-control" id="recom_use" placeholder="추천용도" name="recom_use">
                        </div>
                        <div class="col-sm-4 col-md-3 col-lg-2 mb-1">
                            <input type="text" class="form-control" id="heat_cool_way" placeholder="냉난방방식" name="heat_cool_way">
                        </div>
                        <div class="col-sm-4 col-md-3 col-lg-2 mb-1">
                    ...
                    <input type="hidden" id="gubun" name="gubun" value="4">
                </form>
                ...
                <form id="regImg" enctype="multipart/form-data">
                    ...
                    <!-- 등록 버튼 -->
                    <div class="row mt-2">
                        <div class="col-sm-3 btn btn-dark btn-sm m-auto" @click="regBuilding">등록</div>                    
                    </div>
                    <!-- 등록 버튼 -->
                </form>
                <!-- 입력 폼 -->
...
<script src="/resources/js/other/regBuilding.js"></script>