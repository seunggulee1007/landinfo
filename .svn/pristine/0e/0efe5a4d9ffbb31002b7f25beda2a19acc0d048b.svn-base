...
<section class="section bg-light" v-cloak id="appcontroller">
	    	...
	    	<div class="col">
	            ...
	            <div class="row">
	            	<div class="col text-right">
	            		<a class="btn btn-dark btn-sm mb-2" href="/other/regLand" role="button">등록</a>
	                </div>
	            </div>
	            <!-- 버튼 -->	
				...
				<!-- 페이징 -->
	        <input type="hidden" id="url" value="/selectLandList">
	        </div>
	    </div>
	</div>
</section>
